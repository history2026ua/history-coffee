...
export default function GreenCoffeeSection({ greenCoffee, onAdd, onRoast }: Props) {
      ...
      <div className="flex items-center justify-between">
        ...
        <div className="flex gap-2">
          <Dialog open={roastOpen} onOpenChange={setRoastOpen}>
            ...
            <DialogContent>
              <DialogHeader>
                <DialogTitle>Обсмажити каву</DialogTitle>
              </DialogHeader>
              <div className="space-y-4">
                <div>
                  ...
                  <select
                    ...
                    value={roastId}
                    onChange={(e) => setRoastId(e.target.value)}
                  >
                    <option value="">—</option>
                ...
                <div>
                  ...
                  <Input type="number" step="0.1" value={roastWeight} onChange={(e) => setRoastWeight(e.target.value)}
                    max={selectedGreen?.weightKg} />
                  {roastWeight && (
          ...
          <Dialog open={addOpen} onOpenChange={setAddOpen}>
            ...
            <DialogContent>
              <DialogHeader>
                <DialogTitle>Додати зелену каву</DialogTitle>
              </DialogHeader>
              <div className="space-y-4">
